...
<h1>What this game IS</h1>
  <v-card color="red-darken-2">
      ...
      <p>
        ...
        problem, and there is no ambiguity regarding where the
        heroes and villains are in relation to each other. The
        hobgoblin troopers are setting themselves up in a line to
      ...
      <p>
        ...
        back, and on my turn I can use Phalanx Forward to get us
        all into melee with the death captain.”
        We think focusing on teamwork also makes the game
        more heroic! :D
        In a tactical game, you have many choices each round. You
        are never reduced to just swinging your sword. You have
        options. If we do a good job, you don’t feel like you
        outlasted your opponents because you wore their Stamina
      ...
      <p>
        ...
        start to learn these unique characters, and rely on them to
        do their cool things. It’s a great feeling when another
        player comes up with a cool plan that relies on your
        unique abilities.
        You learn which characters are the “squishies” who need
        to be protected or healed. You learn which characters can
  ...
  <v-card color="blue-darken-2">
    ...
    <v-card-text>
      <p>
        Closely tied to the heroic keyword, the cinematic keyword
        is about how we like powers and abilities with a strong
        visual component. You can imagine your character doing
        or saying these things. “In All This Confusion” is a good
        name for the shadow’s ability to slip out of melee and
      ...
      <p>
        ...
        if we’ve done a good job, when you read the character’s
        abilities, you think, “Yes! This is what I was imagining! I
  ...
  <v-card color="purple-darken-2">
    ...
    <v-card-text>
      <p>
        ...
        medieval fantasy. We like that stuff! Vasloria is our
        medieval European fantasy analog with knights on
        horseback and wizards in towers. But we also like high
        fantasy urban intrigue, and so we’re developing Capital,
        the City of the Great Game, the Greatest City In This or Any
        ...
        minds. You know, telekinesis and telepathy! Jean Grey
        style!
        </p>
    </v-card-text>
  </v-card>
