...
<template>
    ...
    <p class="mx-3">
        ...
        when the rules call for it. Specific rules let you use free
    ...
    <v-card color="grey-lighten-2">
        ...
        <v-card-text>
            Some abilities, like the Tactician’s "Strike Now" ability, allow
            one creature to target another an let them use a signature
            or heroic action. Unless otherwise stated, you can always
            use a free strike in place of the action granted.
        </v-card-text>
    </v-card>
    <br>
    <v-card>
        ...
        <v-card-text>
            Whenever a creature adjacent to you moves to a space that
            isn’t adjacent to you without shifting, you can take
    ...
    <v-card color="grey-lighten-2">
        ...
        <v-card-text>
            Every hero has two standard free strike abilities available
            ...
            improvised weapon. At the Director’s discretion, the
