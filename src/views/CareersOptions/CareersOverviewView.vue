...
<template>
    ...
    <p class="mx-3">
        ...
        experience you gained in that career is now helping you
    ...
    <v-card color="grey-lighten-2">
        ...
        <v-card-text>
            The careers in this section don’t go into great detail about
            the actual jobs they represent. We assume that you know
            the basics of what an artisan, a criminal, or a gladiator
            does for a living. However, each career includes a list of
            questions you should think about to help you define the
            specific details of your hero’s career. For instance, if you
            pick the Artisan career, one of the questions is “What did
            ...
            already have a lot to juggle, but they certainly won’t work
            your backstory into the plot if you never tell them.
        </v-card-text>
    </v-card>
    <br>
    <v-card>
    ...
    <v-card color="grey-lighten-2">
        ...
        <v-card-text>
            ...
            living, and took up the sword (or axe or wand) to become
            an adventuring hero. Each inciting incident represents a
            ...
            Perhaps a person you loved was killed, kidnapped, or
            ...
            prevent that same loss from happening to others. Maybe
            you’ve become an itinerant hero because, after your loss,
            it’s the only thing that gives your life meaning. Maybe all of
            the above. Whatever the case, the loss you’ve suffered is
